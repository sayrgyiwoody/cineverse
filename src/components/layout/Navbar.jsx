...
const Navbar = ({ navFix }) => {
  ...
  return (
    ...
    <div>
      <nav className={`${navFix ? 'fixed w-full top-0 left-0 z-30 ' + animateStyle.fadeInTop : ''} bg-white border-gray-200 dark:bg-gray-800 shadow`}>
      ...
      <div className={` ${showMobileFilter && !filterSubmitted ? '' : 'hidden'} fixed top-0 right-0 h-screen left-0 z-50 justify-center items-center  bg-[#141414cc] dark:bg-[#191616cc]`}>
